...
const blogPosts = [
    ...
    },
    {
        ...
        "CONTENT": {
            ...
            "TEXT_1": "In 2021, halfway into my first quarter back at school, I got a call from a friend of a friend asking if I would be interested in a job helping build a bike park in Alaska. Despite being busy with school, I packed my bags and headed to Alaska for two months. I had never been to Alaska or built trails professionally before, but the opportunity seemed too good to pass up!",
            "TEXT_2": "I showed up and learned that due to some timing issues we had lost two crew members, leaving just Josh, Travis, and myself to build an entire bike park, from scratch, in two months. Luckily, Hill Top is a very small park at roughly 300ft of elevation from top to bottom. Nonetheless, this was a massive undertaking. Hill Top is a nonprofit ski area looking to expand its operations into the summer. Hilltop as far as the terrain goes is relatively boring, flat and lacking in natural features. Josh had promised management that we would build feature-rich trails. To me this seemed far-fetched, especially being only three of us. ",
            "IMAGE_2": "img/trail_building_alaska/bridge.jpg",
            "TEXT_3": "My usual methods of finding cool terrain to build trails were no good here. I got to watch Josh stubbornly dig up big boulders with the machines and manually place them throughout the trails. Creating massive man-made rock gardens. I slowly learned to stop thinking about trail building with my hands and start thinking about trail building with a machine. Usually, I let the natural terrain do the work, digging only where I absolutely must. At Hilltop, I learned to look at the terrain like a blank canvas, building literally whatever I wanted wherever I wanted it through the use of heavy equipment.",
            "IMAGE_5": "img/trail_building_alaska/mini_ex.jpg",
            "IMAGE_3": "img/trail_building_alaska/josh_rock_garden.jpg",
            "TEXT_4": "I learned how to operate our mini ex and quickly was able to apply my previous trail-building knowledge to it. Bike park jump lines are very hard to create, they need to be fun for riders who are clearing the jumps as well as riders rolling through at a slower speed. This meant a lot of fine-tuning and learning from our mistakes as we built. We religiously stayed behind the golden rule: Build jump trails from the top down. Building jump trails from the bottom up will make gauging the future trail speed virtually impossible. This is a concept very familiar to me and should be to anybody that has tried to build a jump line before. Building these trails I really enjoyed being an expert on certain concepts and still learning so much about others.",
            "IMAGE_4": "img/trail_building_alaska/dirt-pile.jpg",
            "TEXT_5": "While I was out learning in the field, I was also finishing up my first quarter at Whatcom community college. The quarter did not go well, I got A’s in both classes but felt as though I wasn’t learning with virtual classes. This was when I decided to try self-teaching for a bit. So armed with Morris Kline’s Calculus textbook and the internet, I taught myself basic calculus and web development in the time I wasn’t spending at the mountain. 10-12 hour days of manual labor followed by 3-4 hours of self-motivated school is probably the most productive I will ever be.",
            "IMAGE_6": "img/trail_building_alaska/behind-the-sticks.jpg",
            "TITLE_2": "We Did it",
            "TEXT_6": "The job required a lot more than just manual labor. Building trails that are fun is very lucrative and up to interpretation. Josh, Travis, and I all had a ton of our own trail-building experience. This means we all had our own ideas of how the trail should be built. This led to a lot of conflicts of interest. Being on a time crunch did not help this fact. This means communication under stress was vital to our success. This forced me to focus on my ability to communicate my ideas in a clear way that is understandable to the person I am talking to. ",
            "IMAGE_8": "img/trail_building_alaska/hilltop-website.png",
            "TEXT_7": "After two long hard months the three of us, along with some help had successfully created a bike park! It was small but contained many features new to Alaska. Jumps that you didn’t need to pedal or break into were a new thing here. Not to mention the amount of work we spent tuning the shape of the lips on the jumps so as to not throw beginner riders over the handlebars. The park was a smashing success and brought traffic from all over Alaska. Hilltop signed a contract with Pro Trails to build there for years to come. I was happy to be a part of such a successful project. I will not miss the bugs!!",
    ...
    },
    {
        ...
        "CONTENT": {
            ...
            "TEXT_1": "If they don’t make it, build it! That was the approach behind this project. My buddy Pat learned through the grapevine that I was in a hardtail phase and had some weird geometry ideas. Pat, who welds bikes on the side for fun, was looking for test subjects to try out frames while he worked out his building methods. To say the least, I was more than willing. Pat and I grabbed a beer over some graph paper and a pencil. Pat loved that I wanted to try something different and the rest is history. ",
            "IMAGE_2": "img/ferrous/truck_bed.jpg",
            "TEXT_2": "Having worked around mountain bikes most of my career I am very comfortable talking numbers, headtube, reach, etc. Despite this, I had never paid much mind to hardtails. This changed when I built up an old Transition TransAm frame I had been gifted. Naturally, being me I put the largest fork I could up front. At 160mm it was overforked by 30mm. Now, I knew this would ride like garbage, I was however unprepared for exactly how bad it would be. This really got my head turning thinking about how potential geo changes would affect the bike. I was really fascinated by how hardtail geo seemed to go against everything I had learned with full-suspension bikes. On top of this, nobody else seemed to be talking about what I was seeing.",
            "TEXT_3": "Obviously, a hardtail does not behave like a full-suspension bike. Yet, 99% of hardtail geometry is based on or directly copies the geometry of their full-suspension counterparts. Why is this? My guess is most companies put r&d into bikes they can actually sell, not aggressive hardtails. But neither Pat or I cared about selling this design, so we took a wild approach to the geo.Now how a bike “feels” when it rides is extremely hard to quantify. I started by taking note of how both kinds of bike geometry changed as the bike cycled through its travel. When you ride a bike, specifically downhill, where you sit in the travel is very different than the bike at full travel or even sag. As the full suspension compresses, it sinks more or less straight into the ground and all angles more or less maintain their slope. The hardtail however pivots around the rear axle, every single angle is changed. The only things noticeably changing on the full suspension are the chainstay length and the bb drop. The hardtail? Totally different. Most noticeable, the headtube starts steepening its angle at an exponential rate. The stack height starts to plummet again exponentially. The only thing that noticeably doesn’t drop out from under you is the bottom bracket height, it stays relatively put. These differences made me feel like I could design something better than what is out there.",
            "TITLE_2": "Version #1",
            "TEXT_4": "The goal of making a hardtail that rides like a full suspension bike requires a much broader approach than just copying geo over. I started with the Transition Sentinal, a ground-breaking bike in the realm of capable mid-travel bikes, and my target bike for ride feel. For the first version, all I was focused on was the headtube angle. This obviously is a huge part of why the sentinel rides so well and why the Trans Am rode so poorly. I chose to base my numbers on a 170mm fork. My thought being I would use the first 150mm of the fork to ride and the last 20mm for big compressions. I settled on a 63-degree head tube angle. Paired with the fork set up very stiff it should give me a riding 64-65-degree angle. I kept the reach at 450mm and 420mm for the chainstays, I like the fit of medium frames and felt no reason for there to be a longer reach. For the bottom bracket, I ended up with a 70mm drop. Pat liked the design and within a few months, we had ourselves a frame!",
            "IMAGE_1": "img/ferrous/v2_benchtop.JPG",
            "TEXT_5": "It was a great first attempt. It rode very well but was clearly not 100% thought out. I rode that bike like it was a downhill bike for half a season before eventually breaking it. After bribing Pat with some beer, I was back on it for another month before it gave out a second time. Pat was eager to try out some new frame-building techniques and with my head full of new geometry ideas, we set out to plan and make a second one. ",
            "IMAGE_4": "img/ferrous/fix_me_plz.jpg",
            "IMAGE_3": "img/ferrous/v1_v2_sidebyside.jpg",
            "TITLE_3": "Version #2",
            "TEXT_6": "With the headtube angle figured out, I turned my attention to the bottom bracket drop for version 2. Now, bb drop is critical for handling any bike down a hill. At 70mm V1 sat almost 50mm lower static than my Knolly Delirium at the time. At sag, they were almost identical. This was good, but I felt the bikes should match at ride height not sag. This is crazy because to most people a 70mm bb drop is insane. For example, the Chromag Doctahawk has a 48mm drop. The reason I wasn’t worried is simply that the Knolly’s bb was dropping 170mm through travel and V1 was only dropping 45mm. Plenty of room!! For V2 we dropped the bb down to 80mm and it made a world of difference on descents while really not changing the amount of pedal strikes that I got. We also shaved half a degree off the headtube but kept the rest the same. ",
            "IMAGE_5": "img/ferrous/v2_fancy1.jpg",
            "IMAGE_6": "img/bike_riding/bike_jumping.jpg",
            "TEXT_7": "The bike is in my mind wildly successful at achieving its goal. Aside from the jarring fact that there is no rear suspension, V2 really feels like a full suspension. The low bb and slack ride height headtube make it corner like no other hardtail I’ve ridden. The moderate reach and chainstays make it fit just like a medium-full suspension bike. It encourages you to ride over the front without trying to through you over the bars. I am very happy with my design and Pats' refined welding.",
            "TITLE_4": "Future",
            "TEXT_8": "The current version has been going strong for over a year. We are both very happy with it and often talk about doing a third version. I’m not really sure what we would change. Part of me wants to add another 10mm to the bb drop and take another half degree off. This is only out of curiosity for trying to find the limit for when dropping a bb starts to feel bad.",
